...
setwd("/Users/robertaazzi1/Desktop/") # Change HERE
...
##############
# CepespData #
df<-as.data.frame(get_votes(2014, "Senator", "Municipality"))
head(df)
...
df<-do.call(rbind, matching)
head(df); nrow(df); table(df$two_states)
